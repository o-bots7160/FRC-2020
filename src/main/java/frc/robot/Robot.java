...
public class Robot extends TimedRobot {
  ...
  private final WestCoastDrive Drive = new WestCoastDrive(m_timer);
  ...
  private final LED led = new LED(m_timer);
  ...
  public void autonomousPeriodic() {
    ...
    led.autonomousPeriodic();

    switch (step) {
    case STEP_1:
      Drive.autonomousMove(90.0d);
      step = autonomousStep.STEP_2;
      break;
    case STEP_2:
      if (Drive.atLocation()) {
        Drive.autonomousRotate(-90.0d);
        step = autonomousStep.STEP_3;
      }
      break;
    case STEP_3:
      if (Drive.atAngle()) {
        Drive.autonomousMove(5.0d);
        shooter.idle();
